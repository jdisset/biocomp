...
DEFAULT_COMPUTE_CONFIG.set('transcription', transcription)
DEFAULT_COMPUTE_CONFIG.set('translation', translation)
DEFAULT_COMPUTE_CONFIG.set('inv_transcription', inv_transcription)
DEFAULT_COMPUTE_CONFIG.set('inv_translation', inv_translation)
DEFAULT_COMPUTE_CONFIG.set('sequestron_ERN', ERN5p)
DEFAULT_COMPUTE_CONFIG.set('sequestron_ERN3p', ERN3p)
DEFAULT_COMPUTE_CONFIG.set('source', source)
DEFAULT_COMPUTE_CONFIG.set('inv_source', inv_source)
DEFAULT_COMPUTE_CONFIG.set('numeric', numeric)
DEFAULT_COMPUTE_CONFIG.set('inv_numeric', inv_numeric)
DEFAULT_COMPUTE_CONFIG.set('aggregation', aggregation)
DEFAULT_COMPUTE_CONFIG.set('inv_aggregation', inv_aggregation)
DEFAULT_COMPUTE_CONFIG.set('output', grouped_output)
DEFAULT_COMPUTE_CONFIG.set('deadend', single_passthrough)
